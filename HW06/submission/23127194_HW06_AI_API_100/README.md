...
- Main report: `Main-Report.md` (includes the full AI Audit Report as Appendix C)
- Standalone AI audit: `ai/AI-Audit-Report.md`
- AI critique: `ai/AI-Critique.md`
- Consolidated Excel suite: `API-Test-Cases.xlsx`
- Postman collections and Newman HTML reports: `postman/`
- Postman features used: `postman/Postman-Features.md`
- CI/CD report, pipeline YAML, run evidence and screenshots: `cicd/`
- AI-driven generator diagram, pseudocode and implementation: `agent-skill/`
- Confirmed bug reports plus runtime and GitHub Issue screenshots: `bugs/`
- Git commit history: `git-commit-log.txt`
- API inventory, selected APIs, specification and execution plan: `supporting/`
- Complete package index: `SUBMISSION-MANIFEST.md`

## Repository Links

- GitHub repository: `https://github.com/nhphunng/SoftwareTesting-Homework`
- Bug Issues: `https://github.com/nhphunng/SoftwareTesting-Homework/issues/24` through `/30`; screenshots of each public GitHub Issue page are included in `bugs/screenshots/GitHub-Issue-24.png` through `GitHub-Issue-30.png`.
