# Real-execution evidence checklist
...
- [ ] Recommendations: source-backed feasibility classification.
- [ ] Genuine issues: GitHub links/screenshots, if observed.
- [ ] Video: ≥6 minutes, Vietnamese voice, tool/resources same frame, skill demonstration.
- [ ] Documents: main Markdown/PDF, audit Markdown/PDF, critique 200–300 words, README, commit log.
- [ ] Final zip: `23127194_HW05_AI_Performance_<000-100>.zip`.
