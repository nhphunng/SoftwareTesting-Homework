...
- Never fabricate `.jtl` logs, test execution, HTML reports, screenshots, resource usage, hardware evidence, GitHub issues, demo video evidence, or human review.
- Distinguish AI-proposed workload parameters, thresholds, and optimizations from tester-validated or measured results.
- Preserve exact user prompts and repository-relative artifact paths in the AI Audit Report.
